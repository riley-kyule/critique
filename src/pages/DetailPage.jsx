...
const DetailPage = () => {
  ...
  <div className="max-w-2xl mx-auto">
    ...
    <span className="mb-4 flex items-center">
      ...
      <button
        type="button"
        className="flex items-center focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2"
