...
import backgroundImage from '../assets/blog-header.jpg';

const Jumbotron = () => {
  return (
    <section className="bg-teal-700 mt-12" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center'}} >
  <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
    <h1 className="mb-8 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl text-white">
      Welcome to Critique Blog
    </h1>
